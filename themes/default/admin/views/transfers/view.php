            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped order-table">
                    ...
                    <tr>
                        ...
                        <th style="text-align:center; vertical-align:middle;"><?= lang("quantity"); ?> PCS</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:center; width:80px; "><?= $this->sma->formatQuantity($row->unit_quantity).' ' ?></td>
                             ...
                             <td style="text-align:left;">
                                <?php if($row->expiry && $row->expiry != '0000-00-00') echo date('d-M-Y', strtotime($row->expiry)); else { 
                                echo "-";
                                }?>
                            </td>
