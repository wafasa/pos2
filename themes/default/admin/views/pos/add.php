        ...
        <div class="container">
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown">
                        <a class="btn blightOrange pos-tip" id="get_cart" title="<span>DRAFT POS</span>" data-placement="bottom" data-html="true" href="<?=admin_url('pos/get_cart')?>" data-toggle="ajax">
                            <i class="fa fa-th"></i>
                        </a>
                    </li>
                    <li class="dropdown">
        ...
        <div class="c1">
            <div class="pos">
                ...
                <div id="pos">
                    ...
                    <input type="hidden" name="cart" value="<?php echo $this->input->get("cart") ?>">
                    <div id="leftdiv">
                        <div id="printhead">
...
<div class="modal fade in" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2"
     aria-hidden="true"></div>
<div class="modal fade in" id="myModalSalesDraft" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2"
  aria-hidden="true"></div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        if ('<?php echo $this->input->get("cart")  ?>'){
            var storage_session = <?php echo json_encode($this->session->userdata("cart")[$this->input->get("cart")]) ?>;
            // console.log(storage_session.data);return;
            console.log(storage_session.data);
            localStorage.setItem('positems', storage_session.data);
            // $.each( storage_session, function( key, value ) {
...
<?php if ($this->input->get('customer')) {?>
        ...
        $("#add_item").autocomplete({
            source: function (request, response) {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: { 
                        total_transaksi : $("#gtotal").text(),
                        term: request.term,
                        warehouse_id: $("#poswarehouse").val(),
                        customer_id: $("#poscustomer").val()
                    },
                    success: function (data) {
                        console.log($("#gtotal").text());
        ...
        $(document).on('click', '.product', function (e) {
            ...
            $.ajax({
                ...
                data: {code: code, warehouse_id: wh, customer_id: cu, total_transaksi : $("#gtotal").text()},
                dataType: "json",
                success: function (data) {
                    e.preventDefault();
                    if (data !== null) {
        ...
        $('#suspend').click(function () {
            if (count <= 1) {
                ...
                title: "<i class='fa fa-key'></i> Please Type "+codes,
