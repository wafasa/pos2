...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close modal-reload" data-dismiss="modal" aria-hidden="true"><i class="fa fa-2x">&times;</i>
            </button>
        ...
        <div class="modal-body">
            ...
            <table width="100%" class="stable">
                ...
                <tr>
                    <td style="border-bottom: 1px solid #EEE;"><h4>Debit:</h4></td>
                    <td style="text-align:right; border-bottom: 1px solid #EEE;">
                        <h4>
                            <span><?= $this->sma->formatMoney($debitsales->paid ? $debitsales->paid : '0.00') . ' '; ?></span>
                        </h4>
                    </td>
                </tr>
                <tr>
