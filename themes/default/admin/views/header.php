...
<div id="app_wrapper">
    <header id="header" class="navbar">
        <div class="container">
            <a class="navbar-brand" href="<?= admin_url() ?>"><span class="logo"><img src="http://naturerepublic.id/pos/assets/uploads/logos/logo_hijau1.png" alt="Inventory"></span></a>
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <?php if ($Owner) { ?>
                    <li class="dropdown hidden-sm">
                        <a class="btn tip" title="Code Setting" data-placement="bottom" href="<?= admin_url('code') ?>">
                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    ...
                                    <li id="products_expiry">
                                        <a class="submenu" href="http://naturerepublic.id/pos/admin/reports/expiry_alerts">
                                            <i class="fa fa-file-text"></i>
                                            <span class="text"> Expire Product</span>
                                        </a>
                                    </li>
                                    <li id="products_index">
                                        <a class="submenu" href="<?= admin_url('products/discount'); ?>">
                                            <i class="fa fa-barcode"></i>
                                            <span class="text"> <?= lang('discount_products'); ?></span>
                                        </a>
                                    </li>
 ...
 <li class="mm_purchases">
                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul>
									...
									<li id="pos_sales_csv">
                                        <a class="submenu" href="<?= admin_url('pos/add_excel'); ?>">
                                            <i class="fa fa-heart"></i>
                                            <span class="text"> Add POS Sales From Excel </span>
                                        </a>
                                    </li>
                            ...
                            <li class="mm_logs">
                                <a class="submenu" href="<?= admin_url('logs'); ?>">
                                    <i class="fa fa-question-circle"></i><span class="text"> <?= lang('Logs'); ?></span>
                                </a>
                            </li>
                            <?php if ($Owner) { ?>
                                <li class="mm_system_settings <?= strtolower($this->router->fetch_method()) == 'sales' ? '' : 'mm_pos' ?>">
                                    ...
                                    <ul>
                                        <li id="system_settings_banner">
                                            <a href="<?= admin_url('system_settings/banner') ?>">
                                                <i class="fa fa-image"></i><span class="text"><?= lang('Banner'); ?></span>
                                            </a>
                                        </li>
                                  ...
                                  <!--   <li id="reports_adjustments">
                                    ...
                                    <li id="reports_sales_detail">
                                        <a href="<?= admin_url('reports/sales_detail') ?>">
                                            <i class="fa fa-heart"></i><span class="text"> <?= lang('sales_report_detail'); ?></span>
                                        </a>
                                    </li>
