                            ...
                            <div class="col-sm-7">
                                <div class="table-responsive">
                                    <table class="table table-borderless table-striped dfTable table-right-left">
                                        ...
                                        <?php
                                        $sql = "select max(expiry) as expiry from sma_purchase_items join sma_products on sma_products.id=sma_purchase_items.product_id join sma_warehouses on sma_warehouses.id=sma_purchase_items.warehouse_id where sma_products.id = $product->id and (expiry is not null and expiry != '0000-00-00')";
                                        ...
                                        <tr>
                                            <td>Expiry Date</td>
                                            <td><?php echo date('d-M-Y', strtotime($a->expiry));?></td>
                                        </tr>
                                        <?php } else { ?>
