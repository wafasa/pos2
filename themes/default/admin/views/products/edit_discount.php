                ...
                <div class="col-md-5">
                   <div class="form-group standard">
					...
					<div class="form-group standard">
                        ...
                        <?= form_input('start_date', (isset($_POST['start_date']) ? $_POST['start_date'] :  date("Y-m-d H:i:s", strtotime($product->start_date))), 'class="form-control tip date" id="min_trx" required="required"') ?>
                    </div>
					
					<div class="form-group standard">
                        <label class="control-label"> End Date *</label>
                         <?= form_input('end_date', (isset($_POST['end_date']) ? $_POST['end_date'] :  date("Y-m-d H:i:s", strtotime($product->end_date))), 'class="form-control tip date" id="min_trx" required="required"') ?>
                    </div>
                    ...
                    <div class="form-group standard">
                        <label class="control-label">Minimum Transaction</label>
						   ...
						   <input type="number" name="min_trx" min="0" class="form-control tipe" value="<?php echo $product->min_trx;?>"/>
                    </div>
