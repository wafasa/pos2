...
<script type="text/javascript">
    $(document).ready(function () {
        oTable = $('#SlRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getSalesReportDetail/?v=1' . $v) ?>',
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                nRow.id = aData[10]; 
                nRow.className = (aData[6] > 0) ? "invoice_link2" : "invoice_link2 warning";console.log(nRow);
                return nRow;
            },
            ...
            {column_number: 5, filter_default_label: "[<?=lang('qty');?>]", filter_type: "text", data: []},
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo form_open("admin/reports/sales_detail"); ?>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                ?>
                                <?php echo form_dropdown('taxed', $options, (isset($_POST['taxed']) ? $_POST['taxed'] : ""),'class="form-control"'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getSalesReportDetail/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getSalesReportDetail/0/xls/?v=1'.$v)?>";
            return false;
        });
