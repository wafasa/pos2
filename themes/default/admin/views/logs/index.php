...
<script>
    $(document).ready(function () {
        oTable = $('#LogTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('logs/getLogs') ?>',
...
<?= admin_form_open('logs/log_actions', 'id="action-form"') ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('logs'); ?></h2>
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="#" id="delete" data-action="delete">
                                <i class="fa fa-trash-o"></i> <?= lang('delete_logs') ?>
                            </a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="LogTable" class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr>
