...
class system_settings extends MY_Controller
{
    ...
    function getBanners() {
        $this->load->library('datatables');
        $this->datatables
            ->select("{$this->db->dbprefix(('banner'))}.banner_id as id, {$this->db->dbprefix(('banner'))}.banner_src, {$this->db->dbprefix(('banner'))}.banner_type, {$this->db->dbprefix(('banner'))}.banner_date", FALSE)
            ->from("banner")
            ->add_column("Actions", "<div class=\"text-center\"><a href='#' class='tip po' title='<b>" . lang("delete_banner") . "</b>' data-content=\"<p>" . lang('r_u_sure') . "</p><a class='btn btn-danger po-delete' href='" . admin_url('system_settings/delete_banner/$1') . "'>" . lang('i_m_sure') . "</a> <button class='btn po-close'>" . lang('no') . "</button>\"  rel='popover'><i class=\"fa fa-trash-o\"></i></a></div>", "id");
